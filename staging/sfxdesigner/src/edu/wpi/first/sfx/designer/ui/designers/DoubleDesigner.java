 ...
 * @author patrick
 */
public class DoubleDesigner implements Designers.Designer
{
	// TODO: proper number editor
	private TextField ui = new TextField();

	@Override
	public void design(Property type)
	{
		ui.textProperty().bindBidirectional(type.getProperty(),new NumberStringConverter());
	}
